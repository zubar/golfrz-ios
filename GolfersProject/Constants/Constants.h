...
//Link for Ames
static NSString * const kAppStoreUrl = @"https://fb.me/402937166579204";
//Link for Geneva
...
static NSString * const kNoInternetErrorDetial = @"Internet Connection can not be established, please try again later.";
static NSString * const kFailedToConnectAppServerTitle = @"Failed to Connect Application Server!";
...
static NSString * const kNumberHandicapErrorMessage = @"Please enter a number for handicap.";
...
static NSString * const EmailSupportErrorMessage = @"Email is not configured on this device!";
